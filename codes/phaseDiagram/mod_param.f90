      ...
      real*8,parameter::t=5.d3!0.d0
      real*8,parameter::tt=0.d0!2.d3
      real*8,parameter::dt=2.d-4!1.d-5
      real*8,parameter::Teq=0.5d0!0.50d0
      real*8,parameter::gama=1.d0
      real*8,parameter::D0=Teq/gama
      real*8,parameter::m=1.d0
      real*8,parameter::f0=1.d0
      ...
      integer*8,parameter::nA=1365,nB=679
      integer*8,parameter::nC=56
      ...
      integer*8,parameter::nframe2=2000!NINT(t)
      integer*8,parameter::ncel=400
      integer*8,parameter::nclsq=20
